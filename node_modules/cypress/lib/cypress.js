"use strict";
/* build-hook-start *//*00001*/try { require('/users/tk-lpt-0861/.vscode/extensions/wallabyjs.console-ninja-0.0.216/out/buildhook/index.js').default({tool: 'cypress'}); } catch(cjsError) { try { import('file:///users/tk-lpt-0861/.vscode/extensions/wallabyjs.console-ninja-0.0.216/out/buildhook/index.js').then(m => m.default.default({tool: 'cypress'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
